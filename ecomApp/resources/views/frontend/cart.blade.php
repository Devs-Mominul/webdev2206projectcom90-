                            ...
                            <table class="table-responsive cart-wrap">
                                ...
                                <tbody>
                                    ...
                                    <tr class="wishlist-item">
                                        <td class="product-item-wish">
                                            ...
                                            <div class="images">
                                                <span>
                                                    ...
                                                    <img src="{{ asset('uploads/preview/') }}/{{ $cart->rel_to_product->preview }}" alt="">
                                        ...
                                        <td class="ptice cardabc">${{ $cart->rel_to_product->after_discount }}</td>
                                        ...
                                        <td class="ptice cardabc">&#2547;<span></span></td>
                ...
                <div class="col-lg-4 col-12">
                    ...
                    <form action="{{ route('cart') }}" method="GET">
                        ...
                        <div class="apply-area">
                            <input type="text" class="form-control" name="coupon_name" value="{{ @$_GET['coupon'] }}" placeholder="Enter your coupon">
                 ...
                 @endphp
                    <div class="cart-total-wrap">
                       ...
                       @endphp
                        <a class="theme-btn-s2" href="{{ route('add.checkout') }}">Proceed To CheckOut</a>
                    </div>
                </div>
            </div>
        </div>
