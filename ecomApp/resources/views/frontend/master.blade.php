                                                ...
                                                <div class="mini-cart-items">
                                                    <div class="mini-cart-item clearfix">
                                                        <div class="mini-cart-item-image">
                                                            <a href=""><img src="{{asset('frontend')}}/assets/images/cart/img-1.jpg" alt></a>
                                                        </div>
                                                        <div class="mini-cart-item-des">
                                                            <a href="">Stylish Pink Coat</a>
                                        ...
                                        <div class="mini-cart">
                                            ...
                                            <div class="mini-cart-content">
                                                ...
                                                <div class="mini-cart-items">
                                                    ...
                                                    $sub=0;
                                                    @endphp
                                                    @foreach (App\Models\Cart::where('customer_id',Auth::guard('customer')->id())->get() as $card)
                                                    @if ($card->rel_to_product)
                                                      <div class="clearfix mini-cart-item">
                                                          <div class="mini-cart-item-image">

                                                              <a href="#"><img src="{{ asset('uploads/preview/') }}/{{ $card->rel_to_product->preview }}" alt="img"></a>
                                                          </div>
                                                          <div class="mini-cart-item-des">
                                                              <a href="#">{{ $card->rel_to_product->product_name }}</a>
                                                              <span class="mini-cart-item-price">${{ $card->rel_to_product->after_discount }} x 1</span>
                                                              <span class="mini-cart-item-quantity"><a href="#"><i
                                                                          class="ti-close"></i></a></span>
                                                          </div>
                                                    ...
                                                    @php
                                                      $sub+=$card->rel_to_product->after_discount*$card->quantity
                                                    @endphp
                                                    @endif
                                                    @endforeach
