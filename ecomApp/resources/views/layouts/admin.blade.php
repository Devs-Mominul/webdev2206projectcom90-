    ...
    ***********************************-->
    <div id="main-wrapper">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="{{asset('backend')}}/email-inbox.html" class="dropdown-item ai-icon">
				...
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="{{ route('dashboard') }}" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="{{ route('add.category') }}">Category</a></li>
							<li><a href="{{ route('add.subcategory') }}">Subcategory</a></li>
							<li><a href="{{ route('add.brand') }}">Brand</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('add.product') }}">Product</a></li>
                            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Variation</a>
                                <ul aria-expanded="false">
                                    <li><a href="{{ route('add.variation') }}">Variation</a></li>
                                    <li><a href="{{ route('product.list') }}">Product List</a></li>
                                    <li><a href="{{ route('add.coupon') }}">Coupon</a></li>
                                    <li><a href="{{ route('border') }}">Order</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('role.view') }}">Role and Permission</a></li>
                            <li><a href="{{ route('asha.index') }}">Mominul</a></li>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="http://dexignzone.com/" target="_blank">MominulHaque</a> 2024</p>
            </div>
        </div>
        <!--**********************************
            Footer end
